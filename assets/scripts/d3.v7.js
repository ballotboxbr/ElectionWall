...
var interpolateZoom = (function zoomRho(rho, rho2, rho4) {
 	...
 	function zoom(p0, p1) {
 	 	// Extract the values from the input arrays
 	 	...
 	 	// Special case for small differences between the two views
 	 	if (d2 < epsilon2$1) {
 	 	...
 	 	// General case for large differences between the two views
 	 	else {
 	 	 	var d1 = Math.sqrt(d2),
 	 	...
 	 	// Set the duration of the interpolator
 	 	i.duration = S * 1000 * rho / Math.SQRT2;

 	 	return i;
 	}

 	// Set the curvature of the zoom interpolator
 	zoom.rho = function(_) {
 	 	var _1 = Math.max(1e-3, +_), _2 = _1 * _1, _4 = _2 * _2;
 	 	return zoomRho(_1, _2, _4);
 	};

 	// Return the zoom function
 	return zoom;
})(Math.SQRT2, 2, 4);
